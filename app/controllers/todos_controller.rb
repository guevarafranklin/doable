class TodosController < ApplicationController
  ...
  scope = Todo.includes(:project).order(created_at: :desc)
  scope = scope.where(project_id: @project_id) if @project_id.present? && @project_id != "all"

  @todos = scope.page(params[:page]).per(10)
  end
